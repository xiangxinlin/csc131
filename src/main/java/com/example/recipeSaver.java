...
public class recipeSaver {
    ...
    public void saveRecipe(String title, String imageUrl, int servings, int id, String imageType, String summary, String diets, String cuisines, float spoonacularScore, String dishTypes, String ingredients, String instructions, String nutrition, int readyInMinutes) {
        try (MongoClient mongoClient = MongoClients.create(MONGODB_URI)) {
            ...
            Document recipe = new Document("title", title)
                    .append("image", imageUrl).append("servings", servings).append("id", id).append("imageType", imageType)
