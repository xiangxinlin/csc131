...
public class recipeSaver {
    ...
    public void saveRecipe(int id, String title, String imageUrl, String imageType, int servings, boolean saveConfirmed) {
        if (!saveConfirmed) {
        ...
        try (MongoClient mongoClient = MongoClients.create(MONGODB_URI)) {
            ...
            Document recipe = new Document("id", id).append("title", title).append("image", imageUrl).append("imageType", imageType).append("servings", servings);
